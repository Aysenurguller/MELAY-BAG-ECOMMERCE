...
export const ORDER_INTRANSIT_REQUEST = "ORDER_INTRANSIT_REQUEST";
export const ORDER_INTRANSIT_SUCCESS = "ORDER_INTRANSIT_SUCCESS";
export const ORDER_INTRANSIT_FAIL = "ORDER_INTRANSIT_FAIL";
export const ORDER_INTRANSIT_RESET = "ORDER_INTRANSIT_RESET";
